    ...
    <div class="flex min-h-screen">
      ...
      <div class="flex flex-col flex-1 overflow-auto h-screen">
        ...
        <div class="p-6 flex items-start space-x-6">
          <!-- Card Tabel -->
          <div class="bg-white p-6 rounded-md shadow space-y-4 w-2/3">
            ...
            <table class="w-full text-sm border border-gray-400 border-collapse">
              ...
              <tbody>
                <tr class="text-center">
                  ...
                  <td class="border border-gray-400 px-4 py-3 text-left">12</td>
                  <td class="border border-gray-400 px-4 py-3 text-left">Minuman</td>
